...
class Bank:
    ...
    def transfer(self, account1: int, account2: int, money: int) -> bool:
        if account1 in range(1, len(self.balance)+1) and account2 in range(1, len(self.balance)+1):
    ...
    def withdraw(self, account: int, money: int) -> bool:
        if account in range(1, len(self.balance)+1) and self.balance[account-1] >= money:
            self.balance[account-1] -= money
            return True
        return False
